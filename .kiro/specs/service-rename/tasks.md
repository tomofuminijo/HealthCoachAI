...
- [ ] 7. 他サービスからの参照更新
- [ ] 7.1 Healthmate-HealthManager サービスの参照更新
  - ステアリングファイル内の HealthCoachAI 参照を確認
  - 必要に応じて Healthmate-CoachAI に更新
  - _要件: 3.1_

- [ ] 7.2 HealthmateUI サービスの参照更新
...
- [ ]* 10.3 プロパティテスト: 検証方法提供
  - **プロパティ 8: 検証方法提供**
  - **検証: 要件 2.3**

- [ ] 11. 最終確認とクリーンアップ
- [ ] 11.1 古いリソースの削除
  - 古い AgentCore エージェントの削除
  - 古い IAM ロールの削除（必要に応じて）
  - _要件: 2.2_
